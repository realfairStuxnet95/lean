    ...
    <section class="padding-y-100 border-bottom border-light">
        <div class="container">
          <ul class="nav tab-line tab-line tab-line--2x border-bottom justify-content-center mb-4" role="tablist">
           <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#course-description" role="tab" aria-selected="true">
              introduction
            </a>
           </li>
           <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#course" role="tab" aria-selected="true">
              course
            </a>
           </li>
           <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#Progress" role="tab" aria-selected="true">
              Progress
            </a>
           </li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 my-2">
                      <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" data-toggle="pill" href="#module1" role="tab" aria-selected="true">module1</a>
                        <a class="nav-link" data-toggle="pill" href="#module2" role="tab" aria-selected="false">module2</a>
                        <a class="nav-link" data-toggle="pill" href="#module3" role="tab" aria-selected="false">module3</a>
                        <a class="nav-link" data-toggle="pill" href="#exam" role="tab" aria-selected="false">final exam</a>
                      </div>
                    </div>
                    <div class="col-md-9 my-2">
                      <div class="tab-content">
                        <div class="tab-pane fade show active" id="v-pills-home module1" role="tabpanel" aria-labelledby="pills-home-tab">
                            <section class="">
                            <div class="container">
                              <div class="row">
                                ...
                                <ul class="nav tab-state-primary mb-3" role="tablist">
                                   <li class="nav-item m-2">
                                     <a class="nav-link bg-light rounded-pill active show" data-toggle="tab" href="#Tabs_77-1" role="tab" aria-selected="true">
                                      introduction
                                     </a>
                                   </li>
                                   <li class="nav-item m-2">
                                     <a class="nav-link bg-light rounded-pill" data-toggle="tab" href="#Tabs_77-2" role="tab" aria-selected="false">
                                       reading
                                     </a>
                                   </li>
                                   <li class="nav-item m-2">
                                     <a class="nav-link bg-light rounded-pill" data-toggle="tab" href="#Tabs_77-3" role="tab" aria-selected="false">            
                                       quiz
                                     </a>
                                   </li>
                                 </ul>
                                <div class="tab-content">
                                  <div class="tab-pane fade show active" id="Tabs_77-1" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <p>
                                  ...
                                  <div class="tab-pane fade" id="Tabs_77-2" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <p>
                                  ...
                                  <div class="tab-pane fade" id="Tabs_77-3" role="tabpanel" aria-labelledby="pills-contact-tab">
                                      
                                          <div class="container">
                                            <div class="row">
                                              
                                              <div class="col-md-4 my-4">
                                                  <p>a problem to answer </p>
                                                <label class="ec-radio radio-xl mb-3 mr-4">
                                                  <input type="radio" name="radio">
                                                  <span class="ec-radio__control"></span>
                                                  <span class="ec-radio__label">option one </span>
                                                </label>
                                                <br>
                                                <label class="ec-radio radio-xl mb-3 mr-4">
                                                    <input type="radio" name="radio">
                                                ...
                                                <br>
                                                <button class="btn btn-pill btn-outline-success mr-3 mb-3">submit</button>
                        ...
                        <div class="tab-pane fade" id="v-pills-profile module2" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <section class="">
                                <div class="container">
                                  <div class="row">
                        ...
                        <div class="tab-pane fade" id="v-pills-messages module3" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <section class="">
                                <div class="container">
                                  <div class="row">
                        ...
                        <div class="tab-pane fade" id="v-pills-settings exam" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <section class="">
                                <div class="container">
                                  <div class="row">
